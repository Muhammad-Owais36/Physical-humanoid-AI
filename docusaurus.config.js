...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      // API configuration for the chat interface with environment-based settings
      apiConfig: {
        // Use environment variable or default to localhost for development
        baseUrl: process.env.REACT_APP_API_BASE_URL ||
                 (process.env.NODE_ENV === 'production' ? 'https://api.yourdomain.com' : 'http://localhost:8000'),
        endpoints: {
          chat: '/api/v1/chat',
          health: '/health',
          ask: '/api/v1/ask',
        ...
        timeout: parseInt(process.env.REACT_APP_API_TIMEOUT || '30000'), // 30 seconds default
        // Additional configuration options
        retryAttempts: parseInt(process.env.REACT_APP_API_RETRY_ATTEMPTS || '3'),
        retryDelay: parseInt(process.env.REACT_APP_API_RETRY_DELAY || '1000'), // 1 second default
      },
      footer: {
        style: 'dark',
        links: [
